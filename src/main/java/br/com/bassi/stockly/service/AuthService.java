...
import br.com.bassi.stockly.client.AuthClient;
import br.com.bassi.stockly.client.dto.AuthRequest;
import br.com.bassi.stockly.config.AppConfig;
import br.com.bassi.stockly.exception.StocklyException;
...
public class AuthService {
    ...
    private void generateToken() {
      ...
      if(!response.getStatusCode().is2xxSuccessful()){
        throw  new StocklyException("cannot generate token, status: " +
